...
export function DueCounter({ label, count, variant = "default" }: DueCounterProps) {
  return (
    <Card className={cn(
      "inline-flex items-center gap-2 p-2",
      variant === "destructive" && "border-red-200 bg-red-50 dark:border-red-900 dark:bg-red-950"
    )}>
      <span className={cn(
        "text-2xl font-bold",
