-- Add development seed data if it doesn't exist
BEGIN;

-- Only insert test data if it doesn't exist
DO $$
BEGIN
    -- Insert test clients if they don't exist
    IF NOT EXISTS (SELECT 1 FROM clients WHERE id = '11111111-1111-1111-1111-111111111111') THEN
        INSERT INTO clients (
            id,
            contact_email,
            full_name,
    ...
    IF NOT EXISTS (SELECT 1 FROM clients WHERE id = '22222222-2222-2222-2222-222222222222') THEN
        INSERT INTO clients (
            id,
            contact_email,
            full_name,
    ...
    -- Insert project templates if they don't exist
    IF NOT EXISTS (SELECT 1 FROM project_templates WHERE id = '33333333-3333-3333-3333-333333333333') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM project_templates WHERE id = '44444444-4444-4444-4444-444444444444') THEN
        INSERT INTO project_templates (
            id,
            name,
            service_type,
    ...
    -- Insert workflow templates if they don't exist
    IF NOT EXISTS (SELECT 1 FROM workflow_templates WHERE id = '55555555-5555-5555-5555-555555555555') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM workflow_templates WHERE id = '66666666-6666-6666-6666-666666666666') THEN
        INSERT INTO workflow_templates (
            id,
            name,
            service_type,
    ...
    -- Insert document templates if they don't exist
    IF NOT EXISTS (SELECT 1 FROM document_templates WHERE id = '77777777-7777-7777-7777-777777777777') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM document_templates WHERE id = '88888888-8888-8888-8888-888888888888') THEN
        INSERT INTO document_templates (
            id,
            name,
            category,
    ...
    IF NOT EXISTS (SELECT 1 FROM projects WHERE id = '99999999-9999-9999-9999-999999999999') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM projects WHERE id = 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa') THEN
        INSERT INTO projects (
            id,
            name,
            client_id,
